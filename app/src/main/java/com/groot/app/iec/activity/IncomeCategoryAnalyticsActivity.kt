...
class IncomeCategoryAnalyticsActivity : BaseActivity(), View.OnClickListener {
    private var binding: ActivityIncomeCategoryAnalyticsBinding? = null
    ...
    private var incomeCategoryAnalyticsAdapter: IncomeCategoryAnalyticsAdapter? = null
    private var analyticsList: ArrayList<DataItem>? = null
    private var incomeMoneyInListAdapter: IncomeMoneyInListAdapter? = null
    private var moneyInList: ArrayList<com.groot.app.iec.model.payment_method.DataItem>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityIncomeCategoryAnalyticsBinding.inflate(
            layoutInflater
        )
        setContentView(binding!!.root)
        analyticsList = ArrayList()
        moneyInList = ArrayList()
        ...
        if (Source.equals("Salary", ignoreCase = true)) {
            binding!!.ivCategory.setImageDrawable(resources.getDrawable(R.drawable.ic_salary))
        } else if (Source.equals("My Business", ignoreCase = true)) {
            binding!!.ivCategory.setImageDrawable(resources.getDrawable(R.drawable.ic_my_business))
        } else if (Source.equals("Pocket Money", ignoreCase = true)) {
            binding!!.ivCategory.setImageDrawable(resources.getDrawable(R.drawable.ic_pocket_money))
        } else {
        ...
        binding?.dialogSelectMonth?.txtdropdown?.adapter = SelectFilterAdapter(
            this@IncomeCategoryAnalyticsActivity,
        ...
        binding?.apply {
            ...
            btnBack.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            headerTitle.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnJanuary.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnFebruary.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnMarch.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnApril.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnMay.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnJune.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnJuly.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnAugust.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnSeptember.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnOctober.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnNovember.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnDecember.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnAll.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnTodaySave.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            btnFilter.setOnClickListener(this@IncomeCategoryAnalyticsActivity)

            dialogSelectMonth.btn2021.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btn2022.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btn2023.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btn2024.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btn2025.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btn2026.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btn2027.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btn2028.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btn2029.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btn2030.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btn2031.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btn2032.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btn2033.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
            dialogSelectMonth.btnYearSave.setOnClickListener(this@IncomeCategoryAnalyticsActivity)
    ...
    private fun SpinnerAnalyticsListAPICall() {
        try {
            if (isConnectedToInternet(activity)) {
                ...
                params["pay_method"] = RestConstant.ICMoneyIn
                params["type"] = "income"
                params["start_date"] = ""
                params["end_date"] = ""
                    ...
                    override fun onResponse(
                        ...
                        if (response.isSuccessful) {
                            ...
                            if (Objects.requireNonNull(analyticsResponse)?.code == 200) {
                                ...
                                incomeCategoryAnalyticsAdapter = IncomeCategoryAnalyticsAdapter(
                                    activity,
                                    analyticsList!!,
                                    this@IncomeCategoryAnalyticsActivity
                                )
                                binding!!.rcvAnalysis.adapter = incomeCategoryAnalyticsAdapter
                    ...
                    override fun onResponse(
                        ...
                        if (response.isSuccessful) {
                            ...
                            if (Objects.requireNonNull(paymentMethodResponse)?.code == 200) {
                                ...
                                moneyInList!!.addAll(paymentMethodResponse!!.data!!)
                                if (moneyInList != null && moneyInList!!.size > 0) {
                                    binding!!.RCVIncome.layoutManager = LinearLayoutManager(
                                        activity,
                                        LinearLayoutManager.HORIZONTAL,
                                        false
                                    )
                                    incomeMoneyInListAdapter = IncomeMoneyInListAdapter(
                                        activity,
                                        moneyInList!!,
                                        this@IncomeCategoryAnalyticsActivity
                                    )
                                    binding!!.RCVIncome.adapter = incomeMoneyInListAdapter
                                }
