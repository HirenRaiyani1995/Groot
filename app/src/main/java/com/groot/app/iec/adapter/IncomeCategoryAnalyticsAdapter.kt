...
class IncomeCategoryAnalyticsAdapter(
    var context: Context,
    var analyticsList: ArrayList<DataItem>,
    var incomeCategoryAnalyticsActivity: IncomeCategoryAnalyticsActivity
) : RecyclerView.Adapter<IncomeCategoryAnalyticsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(myViewHolder: MyViewHolder,@SuppressLint("RecyclerView") i: Int) {
        ...
        myViewHolder.rowFG.setOnClickListener {
            incomeCategoryAnalyticsActivity.transactionListClick(
                i
            )
        }
    }
