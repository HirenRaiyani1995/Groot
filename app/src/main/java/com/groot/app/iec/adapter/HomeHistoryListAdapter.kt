...
class HomeHistoryListAdapter(
    var context: Context,
    var analyticsList: ArrayList<DataItem>,
    var dashboardActivity: DashboardActivity
) : RecyclerView.Adapter<HomeHistoryListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(
        ...
        myViewHolder.rowFG.setOnClickListener { dashboardActivity.transactionListClick(i) }
