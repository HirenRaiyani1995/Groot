package com.groot.app.iec.utils.full_screen_image;
...
import com.groot.app.iec.utils.full_screen_image.photoview.PhotoView;
...
public class PhotoFullPopupWindow extends PopupWindow {
    ...
    public PhotoFullPopupWindow(Context ctx, int layout, View v, String imageUrl, Bitmap bitmap) {
        ...
        AppCompatImageButton closeButton = (AppCompatImageButton) this.view.findViewById(R.id.ib_close);
        ...
        if (bitmap != null) {
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                parent.setBackground(new BitmapDrawable(mContext.getResources(), Constants_New.fastblur(Bitmap.createScaledBitmap(bitmap, 50, 50, true))));// ));
            } else {
            ...
            Glide.with(ctx).asBitmap()
                    ...
                    .listener(new RequestListener<Bitmap>() {
                        ...
                        public boolean onResourceReady(Bitmap resource, Object model, Target<Bitmap> target, DataSource dataSource, boolean isFirstResource) {
                            if (Build.VERSION.SDK_INT >= 16) {
                                parent.setBackground(new BitmapDrawable(mContext.getResources(), Constants_New.fastblur(Bitmap.createScaledBitmap(resource, 50, 50, true))));// ));
                            } else {
