...
class ExpenseCardTransactionAdapter(
    var context: Context, var analyticsList: ArrayList<DataItem>?,
    var cardTransactionExpenseFragment: CardTransactionExpenseFragment
) : RecyclerView.Adapter<ExpenseCardTransactionAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(myViewHolder: MyViewHolder, i: Int) {
        ...
        myViewHolder.rowFG.setOnClickListener {
            cardTransactionExpenseFragment.transactionListClick(
                i
            )
        }
    }
